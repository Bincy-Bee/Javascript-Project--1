...
// document.getElementById("btns-up-in").addEventListener("click", ()=>{
  
//     window.location.href="http://127.0.0.1:5500/pages/signin.html";

//         document.getElementById("btns-sign-up").style.display = "none";
//         document.getElementById("btns-up-in").style.display = "none";
...
//     document.getElementById("btns-sign-up").style.display = "block";
//     document.getElementById("btns-up-in").style.display = "block";
